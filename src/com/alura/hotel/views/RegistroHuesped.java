...
public class RegistroHuesped extends JFrame {
	 ...
	 * Create the frame.
	 */
	public RegistroHuesped(int bookingsId) {
		...
		lblTitulo.setBounds(610, 55, 230, 42);
		...
		System.out.println(bookingsId);
		String id = String.valueOf(bookingsId);
	...
	private void saveGuest() {
		...
		if (txtFechaN.getDate() != null && !txtNombre.equals("") && !txtApellido.equals("")
			...
			Guests guest = new Guests(txtNombre.getText(), txtApellido.getText(), java.sql.Date.valueOf(fechaN),
					txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(), nreserva);
			this.guestController.save(guest);
