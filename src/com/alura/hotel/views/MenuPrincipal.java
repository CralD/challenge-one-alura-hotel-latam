...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Adán Osorio © 2023");
	...
	private int showConfirmationDialog() {
		...
		int choice = JOptionPane.showOptionDialog(contentPane, panel, "Confirmation", JOptionPane.YES_NO_OPTION,
				JOptionPane.QUESTION_MESSAGE, null, new Object[] { "Continue", "Exit" }, "Continue");
